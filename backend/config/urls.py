...
public_router.register('productos', PublicProductViewSet, basename='public-productos')
public_router.register('guia-materiales', PublicMaterialGuideViewSet, basename='public-guia-materiales')
...
urlpatterns = [
    ...
    path('api/reportes/stock/', StockSummaryView.as_view(), name='stock-summary'),
    path('api/public/', include(public_router.urls)),
    path('api/public/landing/', PublicLandingView.as_view(), name='public-landing'),
]
